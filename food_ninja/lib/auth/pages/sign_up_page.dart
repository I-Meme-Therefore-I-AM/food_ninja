...
import 'package:food_ninja/core/common/utils/show_snack_bar.dart';
import 'package:food_ninja/core/common/widgets/loader.dart';
      ...
      child: BlocConsumer<AuthBlocBloc, AuthBlocState>(
        listener: (context, state) {
          ...
          if (state is AuthSucess) {
            print("user id is ${state.uId}");
            Navigator.pushNamed(context, "/bio_form", arguments: state.uId);
          }
        },
